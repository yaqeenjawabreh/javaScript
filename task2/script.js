...
function showMenu(menu) {
    for(let item in menu){
      console.log("name: "+menu[item].name+" price: "+menu[item].price+" category: "+menu[item].category+" available: "+menu[item].available);
    }
}
showMenu(menu);
...
document.write("order Summary <br>"+"food item : "+selectedFood.name+"<br>"+"Quantity : "+quantity+"<br>"+"total price :"+selectedFood.price*quantity);